...
def modify_pending_order_items(tool: ToolUse, agent: Agent, **kwargs: Any) -> ToolResult:
    ...
    if (payment_method["source"] == "gift_card" and 
        ...
        return {
            "toolUseId": tool_use_id,
            "status": "error",
            "content": [{"text": "Error: insufficient gift card balance to pay for the new item"}]
        }
